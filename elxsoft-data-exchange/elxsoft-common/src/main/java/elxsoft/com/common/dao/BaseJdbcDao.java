 ...
 * <B>中文类名(Name)：</B>基础数据访问 Base JDBC Access<BR>
...
public class BaseJdbcDao
{
	 ...
	 *            每页限制记录数
	 */
	public void appendPageSqlOrcl(StringBuffer sql, int start, int limit)
	{
	...
	/**
	 * 
	 * <B>方法名称 method：</B>拼接分页语句  MySQL<BR>
	 * <B>概要说明 description：</B><BR>
	 * 
	 * @param sql
	 * @param tableName
	 ...
	 * @param pageSize
	 */
	public void appendPageSqlMySQL(StringBuffer sql, String tableName, int offset, int pageSize)
	{
		sql.insert(0, "SELECT * FROM ").append(tableName).append(" ");
